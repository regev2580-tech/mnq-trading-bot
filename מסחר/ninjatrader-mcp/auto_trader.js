...
const DATA_FILE     = path.resolve("C:/Users/regev/New folder/ninjatrader-mcp/data/orderflow.json");
const SIGNAL_FILE   = path.resolve("C:/Users/regev/New folder/ninjatrader-mcp/data/trade_signal.json");
const POSITION_FILE = path.resolve("C:/Users/regev/New folder/ninjatrader-mcp/data/position.json");
const LOG_FILE      = path.resolve("C:/Users/regev/New folder/ninjatrader-mcp/data/auto_log.txt");
const STATE_FILE    = path.resolve("C:/Users/regev/New folder/ninjatrader-mcp/data/auto_state.json");
